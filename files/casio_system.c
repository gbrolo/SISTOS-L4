...
// estructura de configuracion de las tareas
...
// borra la informacion de la configuracion
...
// empieza la simulacion con los procesos
...
int main(int argc, char *argv[])
{
	...
	// obtiene la configuracion de las tareas
	...
	// envia la senal y la configuracion para terminar la simulacion
